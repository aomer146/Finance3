...
def main():
    ...
    while True:
        ...
        choice = input("Seçiminizi girin (1-10 veya q): ").strip().lower()
        ...
        try:
            ...
            if choice == "1":
                ...
                index = int(input("Silmek istediğiniz işlemin sıra numarası: ")) - 1
                delete_transaction(index)
            elif choice == "8":
                index = int(input("Güncellemek istediğiniz işlemin sıra numarası: ")) - 1
